...
class Location(db.Model):
    ...
    entries = db.relationship(
        'Entry', secondary='location_entry', back_populates='films'
    )
...
class Entry(db.Model):
    ...
    locations = db.relationship(
        'Film', secondary='location_entry', back_populates='entries')
...
location_entry_table = db.Table('film_entry',
...
class User(UserMixin, db.Model):
    ...
    favorite_locations = db.relationship(
        'Location', secondary='user_film', back_populates='users_who_favorited')

    def __repr__(self):
        return f'<User: {self.username}>'
    

favorite_films_table = db.Table('user_location',
    db.Column('location_id', db.Integer, db.ForeignKey('film.id')),
